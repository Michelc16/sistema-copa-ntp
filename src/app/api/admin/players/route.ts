...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (!parsed.success) return NextResponse.json({ error: "Dados do atleta inválidos." }, { status: 400 });
    ...
    await db()`INSERT INTO players (id,team_id,name,shirt_number,is_captain,active,sort_order) VALUES (${id},${d.teamId},${d.name},${d.shirtNumber},${d.isCaptain},TRUE,${next_order})`;
